...
type PlayheadDataModalButtonProps = {
  title: string;
  matrixData: number[] | number[][];
  color?: string;
}

const PlayheadDataModalButton: React.FC<PlayheadDataModalButtonProps> = ({title, matrixData, color}) => {
...
export default PlayheadDataModalButton;